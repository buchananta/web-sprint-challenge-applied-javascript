...
1. What is the DOM?
----Document Object Model, it's an object that contains everything displayed by the browser, so that javascript can directly manipulate it
2. What is an event?
----In this context, and user interaction with the browser, or other state-change in the browser.
3. What is an event listener?
----a function that listens for and is invoked when a certain event occurs
4. Why would we convert a NodeList into an Array?
----NodeLists look like an array, but lack the advanced array methods like forEach, map, Filter, reduce.
5. What is a component?
----its one(or more) HTML elements built and put into the DOM when a function is called.
